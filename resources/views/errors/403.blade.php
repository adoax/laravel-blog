...
<svg xmlns="http://www.w3.org/2000/svg" id="robot-error" viewBox="0 0 260 118.9">
    ...
    <g id="robot">
        <g id="eye-wrap">
            ...
            <circle id="eyef" class="eye" clip-path="url(#white-clip)" fill="#000" stroke="#c81912" stroke-width="2" stroke-miterlimit="10" cx="130" cy="65" r="11" />
...
<h2>Aller à <a href="{{route('home')}}">l'accueil</a></h2>
</body>
